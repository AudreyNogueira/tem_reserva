...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    ...
    @Query(value = "SELECT * AS RESULT FROM TB_AVALIACAO R WHERE ID_RESERVA = :idReserve AND ID_USUARIO = :idUser AND ID_RESTAURANTE = :idRestaurant GROUP BY ID_RESTAURANTE LIMIT 1", nativeQuery = true)
